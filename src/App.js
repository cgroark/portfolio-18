        ...
        <main>
          <article id='about'>
            <div class="row">
              <div class="col-md-8">
                <h1>About</h1>
                <p>I'm a full-stack web developer with experience untangling problems and developing efficient systems and tools in the private and non-profit sectors.</p>
                <hr />
